...
XLSX, legacy XLS, XLSB, HTML, Markdown, CSV/TSV, email (.eml), and
Outlook `.msg`. Structured `extract()` (text/table regions via a
pluggable Engine) is implemented for all 10 of those formats too - PDF
has two swappable engines (pdf-inspector, pdfplumber), everything else
has one each.
"""
